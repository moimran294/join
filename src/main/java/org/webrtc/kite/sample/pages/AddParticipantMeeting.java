...
public class AddParticipantMeeting extends BasePage {
	
	
public static final String TELEBU_PAGE = "https://join.telebu.com/";
	
	public AddParticipantMeeting(Runner runner) {
		super(runner);
	...
	@FindBy(xpath = "//div[@class='conference__call__container__video']/primary-participant")
	WebElement primaryparticipant;

	
	@FindBy(xpath = "//div[@class='conference__call__container__participants--participant']/participant-video")
	List<WebElement> participant_video;
...
public void get_attribute() {
	...
	System.out.println(primaryparticipant.getAttribute("ng-reflect-audio-status"));
